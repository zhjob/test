				...
				.datagrid(
						{
							...
							toolbar : [ 
							   <shiro:hasPermission name="visitrecordappointed:exportSelected">      
							    {
								text : '导出所选外访单',
							 ...
							 <shiro:hasPermission name="visitrecordappointed:exportQuery">    
							{
								text : '导出所查外访单',
							 ...
							 <shiro:hasPermission name="visitrecordappointed:finishToVisit"> 
							{
								text : '完成外访',
							 ...
							 <shiro:hasPermission name="visitrecordappointed:backToAppoint"> 
							{
								text : '返回排程',
							 ...
							 <shiro:hasPermission name="visitrecordappointed:cancelVisit"> 
							{
								text : '撤销外访',
